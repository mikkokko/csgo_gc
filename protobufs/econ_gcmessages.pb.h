...
constexpr EGCItemMsg EGCItemMsg_MAX = k_EMsgGCAdjustEquipSlots;
constexpr int EGCItemMsg_ARRAYSIZE = EGCItemMsg_MAX + 1;

const std::string& EGCItemMsg_Name(EGCItemMsg value);
template<typename T>
inline const std::string& EGCItemMsg_Name(T enum_t_value) {
  ...
  return EGCItemMsg_Name(static_cast<EGCItemMsg>(enum_t_value));
}
...
const std::string& EGCMsgResponse_Name(EGCMsgResponse value);
template<typename T>
inline const std::string& EGCMsgResponse_Name(T enum_t_value) {
  ...
  return EGCMsgResponse_Name(static_cast<EGCMsgResponse>(enum_t_value));
}
...
const std::string& EUnlockStyle_Name(EUnlockStyle value);
template<typename T>
inline const std::string& EUnlockStyle_Name(T enum_t_value) {
  ...
  return EUnlockStyle_Name(static_cast<EUnlockStyle>(enum_t_value));
}
...
const std::string& EGCItemCustomizationNotification_Name(EGCItemCustomizationNotification value);
template<typename T>
inline const std::string& EGCItemCustomizationNotification_Name(T enum_t_value) {
  ...
  return EGCItemCustomizationNotification_Name(static_cast<EGCItemCustomizationNotification>(enum_t_value));
}
...
class CMsgGCGiftedItems final :
    public ::PROTOBUF_NAMESPACE_ID::MessageLite /* @@protoc_insertion_point(class_definition:CMsgGCGiftedItems) */ {
 public:
...
class CMsgCasketItem final :
    public ::PROTOBUF_NAMESPACE_ID::MessageLite /* @@protoc_insertion_point(class_definition:CMsgCasketItem) */ {
 public:
...
class CMsgGCUserTrackTimePlayedConsecutively final :
    public ::PROTOBUF_NAMESPACE_ID::MessageLite /* @@protoc_insertion_point(class_definition:CMsgGCUserTrackTimePlayedConsecutively) */ {
 public:
...
class CMsgGCItemCustomizationNotification final :
    public ::PROTOBUF_NAMESPACE_ID::MessageLite /* @@protoc_insertion_point(class_definition:CMsgGCItemCustomizationNotification) */ {
 public:
